...
<form action="<?php echo site_url("location/ajax_data_export");?>" method="post">
     <table class="table table-bordered table-hover" >
         ...
         <td><input readonly class="calendar" type="text" name="startTime" id="startTime"/></td>
		 <td class="tableleft">结束日期</td>
         <td><input readonly class="calendar" type="text" name="endTime" id="endTime"/></td>
         </tr>
		 <tr>
...
<table class="table table-bordered table-hover definewidth" style="width:1200px;">
    <thead>
    <tr>
	    <th>二维码序列号</th>
        <th>二维码激活状态</th>
...
function common_request(page){
  var url="<?php echo site_url("qr_active/ajax_data_searchTime");?>?inajax=1";
  var data_ = {
    'page':page,
    'time':<?php echo time();?>,
    'action':'ajax_data',
