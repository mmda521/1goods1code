...
class Location extends CI_Controller {
    ...
    * */
    ...
    {
         $this->load->view('1goods1code/location', '');
	...
	/*导出功能 */
	/*public function ajax_data_export1(){	  			
	 $condition = array();
		 //获取库位说明
    ...
    $file_ending = "xlsx";	 
      ...
      $PHPExcel->setActiveSheetIndex(0)
           ...
           echo result_to_towf_new2('1', 1, 'success', null, $url);
    }*/
    ...
    * */
     public function add()
    {      
         $this->load->view('1goods1code/location_add', '');
    }
    ...
    * */
     public function edit()
    {
     ...
     // PC::debug($list);	
	    $this->load->view('1goods1code/location_edit', $list);
